...
OBJS_SERVER=server/fdb-entry.o server/port.o server/switch.o server/tap-port.o server/tcp-port.o server/tcp-port-enumerator.o server/tls-port.o server/tls-port-enumerator.o server/eoip-port.o server/eoip6-port.o server/vswitch.o server/pam-auth.o
